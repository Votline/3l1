...
func (x *AddOrderReq) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *OrderInfoReq) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *DelOrderReq) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
const file_order_service_proto_rawDesc = "" +
	"\n" +
	"\x13order-service.proto\x12\x06orders\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdd\x01\n" +
	...
	"serviceUrl\x12\x1d\n" +
	"\n" +
	"request_id\x18\a \x01(\tR\trequestId\"\x1d\n" +
	...
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\xb1\x02\n" +
